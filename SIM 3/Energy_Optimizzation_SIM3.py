...
alpha = 0                   # fattore di peso per la perdita precisione (potremmo cambiarlo)
...
for i in range(t_start, t_end, t_opt):
    ...
    Q_t2.append((1 - A_t2[i])*100)  # moltiplicare per 100 se si vuole graficare l'accuracy loss (%)
...
for i in range(t_start, t_end, t_opt):
    ...
    Q_t3.append((1 - A_t3[i])*100)  # moltiplicare per 100 se si vuole graficare l'accuracy loss (%)
