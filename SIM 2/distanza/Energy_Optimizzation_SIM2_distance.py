...
x_u = [400] ; y_u = [0]     # vettori posizione utente con solo posizione inziale

v_x = 2 ; v_y = 2           # componenti costanti della velocità dell' utente (modulo è 2.8 m/s == 10 km/h cioè una camminata)
