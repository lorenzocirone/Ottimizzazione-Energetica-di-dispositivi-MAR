...
v_x = 6 ; v_y = 6           # componenti costanti della velocità dell' utente (modulo è 8,4 m/s => 30 km/h ad esempio in bicicletta o monopattino)
...
alpha = 4                   # fattore di peso per la perdita Accuratezza (potremmo cambiarlo)
...
fig.savefig("Grafico1.png", dpi = 1000)  #1000 dpi
fig2.savefig("Grafico2.png", dpi = 1000) #1000 dpi
