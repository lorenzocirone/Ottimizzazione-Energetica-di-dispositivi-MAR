...
fig.savefig('P-d_expanded.png', bbox_inches=extent1.expanded(1.35, 1.35))
fig.savefig('R-d_expanded.png', bbox_inches=extent2.expanded(1.35, 1.35))
fig.savefig('AccLoss_expanded.png', bbox_inches=extent3.expanded(1.35, 1.36))
fig.savefig('EnCons_expanded.png', bbox_inches=extent4.expanded(1.35, 1.36))